<template>
	<view class="home">
		<tm-menubars style="position: fixed;z-index: 999999;" :title="'多房源分享'" iconColor="white"></tm-menubars>
		<view class="wrap" style="position:relative;z-index: 997;">
			...
			<indexHouse :homeFeuer="houselist" :houseid="this.query.type" :househead="2"></indexHouse>
