<template>
	<view class="tm-pickers d-inline-block fulled">
		...
		<!-- #ifdef H5 -->
		<tm-poup @change="toogle" ref="pop" v-model="showpop" :height="920" :bg-color="black_tmeme?'grey-darken-5':bgColor">
		<!-- #endif -->
		<!-- #ifndef H5 -->
...
<script>
	...
	import tmPickersView from "../tm-pickersView/tm-pickersView.vue"
	export default {
