<template>
	<view>
		<tm-menubars title="搬家服务" iconColor="white"></tm-menubars>
		<view class="formbox">
			...
			<uni-forms label-width="100" ref="dklist" :modelValue="dklist">
				...
				<uni-forms-item label="搬家到哪" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
				<uni-forms-item label="有无易碎" name="reference">
					<uni-easyinput v-model="dklist.reference" placeholder="请输入推荐人" />
				</uni-forms-item>
				<uni-forms-item label="搬家时间" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
				<uni-forms-item label="预计人员" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
