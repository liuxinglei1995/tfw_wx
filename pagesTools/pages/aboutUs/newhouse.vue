<template>
	<view>
		<tm-menubars title="新房入住" iconColor="white"></tm-menubars>
		<view class="formbox">
			...
			<uni-forms label-width="100" ref="dklist" :modelValue="dklist">
				...
				<uni-forms-item label="公司名字" required name="num">
					<uni-easyinput v-model="dklist.num" placeholder="请输入手机号" />
				</uni-forms-item>
				<uni-forms-item label="项目名字" required name="num">
					<uni-easyinput v-model="dklist.num" placeholder="请输入手机号" />
				</uni-forms-item>
				...
				<uni-forms-item label="需求" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
