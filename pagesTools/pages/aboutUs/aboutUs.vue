<template>
	<view>
		<tm-menubars title="装修服务" iconColor="white"></tm-menubars>
		<view class="formbox">
			...
			<uni-forms label-width="100" ref="dklist" :modelValue="dklist">
				...
				<uni-forms-item label="小区名" required name="num">
					<uni-easyinput v-model="dklist.num" placeholder="请输入手机号" />
				</uni-forms-item>
				<uni-forms-item label="房号" required name="num">
					<uni-easyinput v-model="dklist.num" placeholder="请输入手机号" />
				</uni-forms-item>
				<uni-forms-item label="面积" required name="num">
					<uni-easyinput v-model="dklist.num" placeholder="请输入手机号" />
				</uni-forms-item>
				<uni-forms-item label="户型" required name="num">
					<uni-easyinput v-model="dklist.num" placeholder="请输入手机号" />
				</uni-forms-item>
				...
				<uni-forms-item label="房屋现状" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
				<uni-forms-item label="装修风格" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
				<uni-forms-item label="装修预算" name="reference">
					<uni-easyinput v-model="dklist.reference" placeholder="请输入推荐人" />
				</uni-forms-item>
				<uni-forms-item label="领包入住" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
				<uni-forms-item label="启动预计" required name="type">
					<uni-data-select v-model="dklist.type" :localdata="tfwlooktypeOptions"></uni-data-select>
				</uni-forms-item>
			...
			<button
				...
				@click="submit('dklist')">提交申请</button>
		</view>
	</view>
</template>
