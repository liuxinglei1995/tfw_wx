	...
	<view class="tm-keyborad ">
		...
		v-model="showOpen">
			<view>
				...
				<view v-if="model_code=='house'" class="tm-keyborad-html">
					<view class=" py-10" :class="[black_tmeme?'grey-darken-5':'grey-lighten-5']">
						<view class="text-size-xs text-align-center pb-20 pt-10 text-weight-b">
							<slot>
								<text>{{title}}</text>
						...
						<tm-row align="flex-start">
							<tm-col grid="12"  color="none" custom-class="px-5">
								<tm-row>
									<tm-col  grid="3" padding="5" color="none">
										<tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b"  @click="clickNumo(1,'num')" :black="black_tmeme" :round="round"  block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color"  height="100">1</tm-button>
									</tm-col>
								...
								<tm-row>
									<tm-col grid="3" padding="5" color="none"><tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(4,'num')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">4</tm-button></tm-col>
									<tm-col grid="3" padding="5" color="none"><tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(5,'num')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">5</tm-button></tm-col>
									<tm-col grid="3" padding="5" color="none"><tm-button :fontSize="42"  :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(6,'num')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">6</tm-button></tm-col>
									<tm-col :grid="decimal?3:8" padding="5" color="none"><tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(0,'num')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">0</tm-button></tm-col>
								</tm-row>
								<tm-row>
									<tm-col grid="3" padding="5" color="none"><tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(7,'num')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">7</tm-button></tm-col>
									<tm-col grid="3" padding="5" color="none"><tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(8,'num')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">8</tm-button></tm-col>
									<tm-col grid="3" padding="5" color="none"><tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(9,'num')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">9</tm-button></tm-col>
									<tm-col  grid="3" padding="5" color="none"><tm-button :fontSize="42" :fllowTheme="false" item-class="text-weight-b" @click="clickNumo(null,'confirm')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="okColor" height="100">确认</tm-button></tm-col>
								</tm-row>
								<tm-row>
									<tm-col grid="2" padding="5" color="none"><tm-button :fontSize="42"  :fllowTheme="false" item-class="text-weight-b" @click="clickNumo('栋','house')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">栋</tm-button></tm-col>
									<tm-col grid="2" padding="5" color="none"><tm-button :fontSize="42"  :fllowTheme="false" item-class="text-weight-b" @click="clickNumo('单元','house')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">单元</tm-button></tm-col>
									<tm-col grid="2" padding="5" color="none"><tm-button :fontSize="42"  :fllowTheme="false" item-class="text-weight-b" @click="clickNumo('楼','house')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">楼</tm-button></tm-col>
									<tm-col grid="2" padding="5" color="none"><tm-button :fontSize="42"  :fllowTheme="false" item-class="text-weight-b" @click="clickNumo('号','house')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">号</tm-button></tm-col>
									<tm-col grid="4" padding="5" color="none"><tm-button :fontSize="42"  :fllowTheme="false" item-class="text-weight-b" @click="clickNumo('物业中心','house')" :black="black_tmeme" :round="round" block :shadow="shadown" :theme="black_tmeme?'grey-darken-4':color" height="100">物业中心</tm-button></tm-col>
								</tm-row>
							</tm-col>
						</tm-row>
					</view>
...
<script>
	 ...
	 */
	import tmIcons from "../tm-icons/tm-icons.vue"
	import tmButton from "../tm-button/tm-button.vue"
	import tmRow from "../tm-row/tm-row.vue"
	import tmCol from "../tm-col/tm-col.vue"
	import tmPoup from "../tm-poup/tm-poup.vue"
	export default {
		...
		methods: {
			clickNumo(val,type){
				...
				}else if(type=='num' || type=='code-x'|| type=='car' || type == 'password' || type == 'house'){
					oval= (oval==null || oval == 'NULL'?'':oval) +'' + val;
				}else if(type=='dian'){
