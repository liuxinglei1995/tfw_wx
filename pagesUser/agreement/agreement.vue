<template>
	<view>
		<tm-menubars title="用户协议" iconColor="white"></tm-menubars>
		<view class="container">
			<view class="top">{{title}}</view>
			<view v-for="(item, index) in agreement" :key="index" class="msg">
				<view class="title">{{item.title}}</view>
				<view v-for="(itemContent,index) in item.content" class="side">{{itemContent}}</view>
			</view>
		</view>
	</view>
</template>
	...
	export default {
		data() {
			return {
				...
				title: "尊敬的客户, 欢迎您注册成为文方天府网用户。在注册前请您仔细阅读如下服务条款:",
				agreement: [{
					title: ' ',
					...
					title: '2、用户必须:',
					content: [
						'(1)自行配备上网的所需设备, 包括个人电脑、调制解调器或其他必备.上网装置。',
						'(2) 自行负担个人， 上网所支付的与此服务有关的电话费用、 网络费用。 '
					],
				}, {
					title: '3、用户在本网站交易平台上不得发布下列违法信息：',
					content: [
						'(1) 反对宪法所确定的基本原则的；',
					...
					title: '5、用户在注册时应当选择稳定性及安全性相对较好的电子邮箱，并且同意接受并阅读本网站发往用户的各类电子邮件。',
					content: [
